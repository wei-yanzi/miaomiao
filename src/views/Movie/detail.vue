<template>
    <div id="detailContent" class="godtail">
        <Header title="影片详情">
...
<style scoped>
    #detailContent{position: absolute;left: 0;top: 0;z-index: 100;width: 100%;min-height: 100%;background-color: white;}
    #detailContent.godtail{animation: 0.3s slideMove}
    @keyframes slideMove {
